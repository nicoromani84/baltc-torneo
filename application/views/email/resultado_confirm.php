...
<body style="padding:0;margin:0;">
	<div style="border:1px solid #e9eaef; border-radius:4px; max-width:600px; margin:0 auto;">
		...
		<div style="padding:30px 20px;">
			...
			<p style="margin:0 0 20px 0;">Hola <strong><?=ucwords(strtolower($nombre))?></strong>, te confirmamos el resultado de tu partido en el Torneo Interno de Dobles del BALTC.</p>
