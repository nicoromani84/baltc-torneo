	...
	<div style="max-width:600px;margin:20px auto;border:1px solid #e9eaef;border-radius:8px;overflow:hidden;background:#fff;">
		...
		<div style="padding:20px 24px;background:#ffffff;display:flex;align-items:center;border-bottom:3px solid #a5d051;">
			...
			<div style="margin-left:16px;">
				...
				<div style="color:#555;font-size:11px;">Torneo Interno de Singles</div>
			</div>
		</div>
		...
		<div style="padding:32px 24px;">
			...
			<p style="color:#555;font-size:16px;margin:0 0 24px 0;">Hola <strong style="text-transform:capitalize;"><?=ucwords(strtolower($nombre))?></strong>, tu inscripción al Torneo Interno de Singles del BALTC fue confirmada.</p>
			...
			<div style="background:#f8f9fa;border-radius:8px;padding:20px;margin-bottom:24px;">
				<table style="width:100%;border-collapse:collapse;">
					...
					<tr>
						...
						<td style="padding:8px 0;font-weight:700;color:#5a7a2e;">19 de Mayo 2026</td>
					</tr>
				</table>
			</div>
