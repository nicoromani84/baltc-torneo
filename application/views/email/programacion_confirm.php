...
<head>
    <meta charset="utf-8" />
    <title>Partido programado</title>
			...
			<div style="background:#f8f9fa; border-radius:8px; padding:20px; margin-bottom:20px;">
				<table style="width:100%; border-collapse:collapse;">
					...
					<tr>
						...
						<td style="padding:8px 0; font-weight:800; color:#5a7a2e; font-size:18px; border-top:1px solid #dee2e6;"><?=$fecha_formateada?></td>
					</tr>
					<?php if(!empty($hora)): ?>
					<tr>
						<td style="padding:8px 0; color:#888; font-size:13px; text-transform:uppercase; letter-spacing:0.5px;">Hora</td>
						<td style="padding:8px 0; font-weight:800; color:#5a7a2e; font-size:18px;"><?=$hora?></td>
					</tr>
					<?php endif; ?>
				</table>
			</div>

			<p style="color:#666; font-size:14px;">Recordá presentarte con al menos 10 minutos de anticipación.</p>
