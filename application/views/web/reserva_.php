				...
				<form class="form-inline">
					...
					<div class="form-group xs-fullwidth">
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="acepto_reglamento" required>
							<label class="form-check-label" for="acepto_reglamento">Acepto el <a href="#" target="_blank">reglamento del torneo</a></label>
						</div>
					</div>
