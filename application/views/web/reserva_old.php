...
<div class="page reserve-page">
	<div id="reservar" class="container">
		<div class="container">
			<h1 class="d-none d-sm-block">Hola <strong><?=$user->name?></strong><br>Inscribite en el Torneo Interno de Dobles</h1>
			<h1 class="d-sm-none">Hola <strong><?=$user->name?></strong>Inscribite en el Torneo Interno de Dobles</h1>
