...
$route['admin/verCategorias'] = 'admin/verCategorias';
$route['admin/verParejasCategoria'] = 'admin/verParejasCategoria';
$route['admin/verParejasCategoria3Json'] = 'admin/verParejasCategoria3Json';
$route['admin/queryMatches'] = 'admin/queryMatches';
