...
<div class="page reserve-page">
	<div id="reservar" class="container">
		<div class="container">
			<h1 class="d-none d-sm-block">Hola <strong><?=$user->name?></strong><br>Torneo Interno de Dobles LED</h1>
			<h1 class="d-sm-none">Hola <strong><?=$user->name?></strong>Inscribite en el Torneo de Dobles LED</h1>
			<p>Durante Junio 2021</p>
			<div class="form">
